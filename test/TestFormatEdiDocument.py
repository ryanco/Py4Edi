...
class TestFormatEdiDocument(unittest.TestCase):
    ...
    def test_simple_edi_document(self):
        simple_edi_document = FixtureFiles.documents.get(FixtureFiles.simple_edi_file)
    ...
    def test_multiple_groups_edi_document(self):
        multiple_edi_groups = FixtureFiles.documents.get(FixtureFiles.multiple_groups_file)
